...
const Footer = () => {
  return (
      <footer id="about-section" className="bg-gray-900 text-white py-4"> {/* Reduced padding for a tighter look */}
          ...
          <div className="bg-gray-700 py-2"> {/* Reduced padding for a tighter look */}
