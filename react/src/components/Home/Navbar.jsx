...
export default function Navbar() {
  return (
    <nav className="bg-gradient-to-r from-cyan-500 to-blue-500 border-2 border-red-500 rounded-md m-1">
      <div className="flex items-center justify-between h-20 m-2">
        {/* Logo */}
        <img
          src={Logo}
          alt="Logo"
          className=" items-center h-16 w-16 border-2 shadow-md shadow-black rounded-lg hover:h-14 hover:w-14 transition-all duration-100"
        />
        
        {/* Navigation Links */}
        <ul className="flex space-x-5 ml-auto text-white">
